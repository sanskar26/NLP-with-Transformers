...
Original file is located at
    https://colab.research.google.com/drive/1TNaP7m7lTSogQ_SSpAiGdm4jBHwXh06a
"""
...
for index,row in df.iterrows():
  ...
  finance_output_token= model.generate(encoded_id_finance,max_length=1000,do_sample=True,top_k=30,top_p=0.95)#num_return_sequences=3
...
#Tried Different Search Techniques:
